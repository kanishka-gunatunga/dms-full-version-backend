...
Route::get('/up', function() { return response()->json(['status' => 'up']); });
...
Route::get('/ad-config', [UserAPIController::class, 'get_ad_config']);
Route::post('/auto-login', [UserAPIController::class, 'auto_login']);
...
Route::get('/user-sectors/{id}', [UserAPIController::class, 'user_sectors'])->middleware('auth:api');
...
Route::post('/users-by-sectors', [UserAPIController::class, 'users_by_sectors'])->middleware('auth:api');
...
// MFA Routes
Route::post('/mfa/generate', [UserAPIController::class, 'mfa_generate'])->middleware('auth:api');
Route::post('/mfa/enable', [UserAPIController::class, 'mfa_enable'])->middleware('auth:api');
Route::post('/mfa/disable', [UserAPIController::class, 'mfa_disable'])->middleware('auth:api');
Route::post('/mfa/verify-login', [UserAPIController::class, 'mfa_verify_login']);
Route::post('/mfa/setup-generate', [UserAPIController::class, 'mfa_setup_generate']);
Route::post('/mfa/setup-enable', [UserAPIController::class, 'mfa_setup_enable']);
...
Route::post('/document-bulk-send-email', [DocumentAPIController::class, 'document_bulk_send_email'])->middleware('auth:api');
...
//AD Routes
Route::get('/import-users', [ADController::class, 'import_users']);
...
//Dashbaord API
Route::get('/admin-dashboard-data', [DashboardController::class, 'admin_dashboard_data'])->middleware('auth:api');
Route::get('/user-dashboard-data', [DashboardController::class, 'user_dashboard_data'])->middleware('auth:api');
Route::post('/renew-document', [DocumentAPIController::class, 'renew_document'])->middleware('auth:api');
Route::get('/get-all-meta-tags', [DocumentAPIController::class, 'get_all_meta_tags'])->middleware('auth:api');


//Signature Routes
Route::get('/pending-signatures', [DocumentAPIController::class, 'pending_signatures'])->middleware('auth:api');
